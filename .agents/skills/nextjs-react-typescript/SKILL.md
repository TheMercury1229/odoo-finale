...
description: Expert in TypeScript, Node.js, Next.js App Router, React, Shadcn UI, Base UI and Tailwind
---
...
- Leverage Shadcn UI, Base UI, and Tailwind for components and styling
